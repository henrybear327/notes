...
- LKML 上提交 patch
  ...
  - [Setup email](https://git-send-email.io/) using gmail on Ubuntu
    ...
    - Get an [app password](https://security.google.com/settings/security/apppasswords)
    - Edit `~/.gitconfig`
      ```text
      [sendemail]
          smtpPass = ...
      ...
      [user]
          ...
          name = ...
      ```
    - Try to send a patch using [the git-send-email.io instructions](https://git-send-email.io/#step-3)
